...
def id_generator(start_id):
    ...
    while current_id <= 999999999:
        if check_id_valid(current_id):
            yield current_id
        current_id += 1
    #יצירת פעולה NEXT שכל עוד התנאי מתקיים בודתק האם תעודת הזהות תקינה ואם כןמחזירה אותה ומעלה את התעודת זהות הנוכחית ב1
...
def main():
    ...
    if choice == "it":
        ...
        #לפי קלט שנקלט  gen or it
        #מפעיל את הפעולה ר=הרצויה ומחיזר את 10 התעודת זהות הבאות התקינות אחרי הת"ז שנקלטה(לא כולל)
